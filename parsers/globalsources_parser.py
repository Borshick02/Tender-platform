...
try:
    from stealth_utils import apply_stealth, block_heavy_resources
except ImportError:
    apply_stealth = None
            ...
            for page_num in range(1, cfg.pages + 1):
                ...
                try:
                    try:
                        ...
                        print("[GlobalSources] goto timeout, продолжаем", file=sys.stderr)
        ...
        for qi, q in enumerate(queries):
            ...
            try:
                try:
                    ...
                    print("[GlobalSources batch] goto timeout, продолжаем", file=sys.stderr)
                page.wait_for_timeout(2000)
                for _ in range(8):
                    try:
                        html_check = page.content()
